...
export default function RoughnessSession({dataController}: {dataController: ReturnType<typeof DataController>}): React.ReactElement{
    ...
    <>
        ...
        <p>Angulo reflexivo: {(dataController.mapController.reflexiveAngle * (180 / Math.PI))} Graus</p>
        <p>Area de reflexão: {dataController.mapController.calculateReflexiveArea()}m²</p>
