...
export default interface MapControllerInterface {
  ...
  calculateNoObstructedValues: (frequence: number, setheightTwoerA: (value: string) => void, setheightTwoerB: (value: string) => void, towerAHeigth: number, towerBHeigth: number, useTecnicalNorm: boolean) => void
  ...
  calculateRainLoss(rainfallRate: number, frequencyGz: number, margem: number): {
    ArH: number
    ArV: number
  ...
  changeOrigin: string,
  setChangeOrigin: (value: string) => void
